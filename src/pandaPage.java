...
public class pandaPage extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Text text1 = new Text("Select a way to interact with the panda");
		...
		button2.setText("Play hit the ball with panda");
