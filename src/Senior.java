...
public class Senior extends Visitor {
	...
	public Senior(String firstName, String middleName, String lastName, int ticketAmt, int age) {
		super(firstName, middleName, lastName, age);

		this.ticketAmt = ticketAmt;
	}

	public Senior(String firstName, String middleName, String lastName, int ticketAmt, int age, String streetAddress, String city,
