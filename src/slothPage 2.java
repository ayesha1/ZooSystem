...
public class slothPage extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Text text1 = new Text("Select a way to interact with the sloth");
