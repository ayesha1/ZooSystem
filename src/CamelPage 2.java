...
public class CamelPage extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		primaryStage.setTitle("Camel");

		Text text1 = new Text("Select a way to interact with the Camel");
		...
		button2.setText("Ride on Camel Back");
