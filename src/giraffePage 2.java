...
public class giraffePage extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		primaryStage.setTitle("Giraffe");

		Text text1 = new Text("Select a way to interact with the giraffe");
		...
		button1.setText("Feed an apricot");
		...
		button1.setOnAction(e -> {
			alert.setText(Giraffe.feedSnack());
		...
		button2.setText("Play with the face");
