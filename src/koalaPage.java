...
public class koalaPage extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Text text1 = new Text("Select a way to interact with the koala");
		...
		button1.setText("Feed a gum leaf");
		...
		button2.setText("Pat koala on the back");
