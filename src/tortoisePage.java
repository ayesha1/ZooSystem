...
public class tortoisePage extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		primaryStage.setTitle("Tortoise");

		Text text1 = new Text("Select a way to interact with the tortoise");
		...
		button1.setOnAction(e -> {
			alert.setText(Tortoise.feedSnack());
		...
		button2.setText("Take pictures with Tortoise");
