...
public class DolphinPage extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Text text1 = new Text("Select a way to interact with the Dolphin");
		...
		button1.setOnAction(e -> {
			alert.setText(Dolphin.feedSnack());
			alert.setFill(javafx.scene.paint.Color.BLUE);

		});

		
		// Play hit the ball with dolphin 
		Button button2 = new Button();
		button2.setText("Play hit the ball with dolphin");
