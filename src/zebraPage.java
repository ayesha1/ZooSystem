...
public class zebraPage extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Text text1 = new Text("Select a way to interact with the zebra");
		...
		button2.setText("Play catch the grass stick");
