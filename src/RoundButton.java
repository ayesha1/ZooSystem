...
/**
 * Sample code for:
 * https://forums.oracle.com/forums/thread.jspa?threadID=2428756 "Problem with a
 * circle shaped border around a button"
 * 
 * Demonstrates three different methods of creating an icon in a scalable close
 * button.
 */
public class RoundButton extends Application {
	...
	public void start(Stage primaryStage) {
		...
		layout.getChildren().addAll(scaleTo(60, closeButton(textCloseIcon(), exitHandler)),
	...
	private Node svgPathCloseIcon() {
		return SVGPathBuilder.create().content("M9 9 L21 21 M9 21 L21 9").styleClass("closeicon").build();
	}
