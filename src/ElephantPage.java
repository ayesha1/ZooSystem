...
public class ElephantPage extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Text text1 = new Text("Select a way to interact with the elephant");
		...
		button1.setOnAction(e -> {
			alert.setText(Elephant.feedSnack());
		...
		button2.setText("Ride on Elephant back");
