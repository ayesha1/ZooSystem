...
public class ParkEmployeeScreen extends Application {
	Button button;
	Button button1;
	Button button2;
	Button button3;
	...
	public void start(Stage primaryStage) throws Exception {
		...
		primaryStage.setTitle("Employee Park Sections");

		Text text1 = new Text("Which section to go to?");
		text1.setStyle("-fx-font-size: 40;");
		
		Button exitButton = new Button("Back to Sign in Page");
		...
		button.setOnAction(e -> {
			TropicalPageEmployee login = new TropicalPageEmployee();
			try {
				login.start(primaryStage);
			} catch (Exception e1) {
				// TODO Auto-generated catch block
		...
		button1.setOnAction(e -> {
			ForestPageEmployee forestPage = new ForestPageEmployee();
			try {
		...
		button2.setOnAction(e -> {
			SavannaPageEmployee savannaPage = new SavannaPageEmployee();
			try {
		...
		button3.setOnAction(e -> {
			desertPageEmployee login = new desertPageEmployee();
			try {
				login.start(primaryStage);
			} catch (Exception e1) {
				// TODO Auto-generated catch block
	     ...
	     button4 = new Button();
			...
			button4.setOnAction(e -> {
				arcticPageEmployee login = new arcticPageEmployee();
				try {
					login.start(primaryStage);
				} catch (Exception e1) {
					// TODO Auto-generated catch block
			  ...
			  button5 = new Button();
				...
				button5.setOnAction(e -> {
					aquaticPageEmployee login = new aquaticPageEmployee();
					try {
						login.start(primaryStage);
					} catch (Exception e1) {
						// TODO Auto-generated catch block
