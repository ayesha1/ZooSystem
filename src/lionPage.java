...
public class lionPage extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Text text1 = new Text("Select a way to interact with the lion");
		...
		button2.setText("Play and tease the cages lion");
