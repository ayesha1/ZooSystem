...
public class gorillaPage extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Text text1 = new Text("Select a way to interact with the gorilla");
		...
		button1.setOnAction(e -> {
			alert.setText(Gorilla.feedSnack());
