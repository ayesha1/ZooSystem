...
public class ForestPage extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		button2.setOnAction(e -> {
			gorillaPage login = new gorillaPage();
			try {
				login.start(primaryStage);
			} catch (Exception e1) {
				// TODO Auto-generated catch block
		...
		button3.setOnAction(e -> {
			tortoisePage login = new tortoisePage();
			try {
				login.start(primaryStage);
			} catch (Exception e1) {
				// TODO Auto-generated catch block
